    ...
    <main className="flex flex-col items-center min-h-screen p-8 max-w-4xl mx-auto">
      <div className="w-full mb-8 text-center">
        <h1 className="text-3xl font-bold mb-2">
          Optimiseur de Découpe de Parquet
        </h1>
        <p className="text-muted-foreground">
          Calculez la disposition optimale de vos lames de parquet pour
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Input
                ...
                onChange={(e) => setRoomWidth(Number(e.currentTarget.value))}
              />
            </div>
            <div className="flex items-center justify-between">
              <label
              ...
              <Input
                ...
                onChange={(e) => setRoomHeight(Number(e.currentTarget.value))}
              />
            </div>
          </div>
        </div>
        ...
        <div className="p-6 border rounded-lg bg-card dark:bg-gray-800 shadow-sm">
          ...
          <div className="flex items-center justify-between">
            ...
            <Input
              ...
              className="w-40 dark:bg-gray-600"
              value={stripWidth}
              onChange={(e) => setStripWidth(Number(e.currentTarget.value))}
            />
          </div>
        </div>
      </div>
